                        ...
                        <div class="col-md-11">
                            ...
                            <div class="card shadow border-left-secondary">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo base_url(); ?>index.php/usuarios/update/<?php echo $cod; ?>" method="POST" id = "user_save_form">
                                        ...
                                        <div class="row clearfix d-flex justify-content-center">
                                            <div class="col-md-4">
                                                <div class="input-group shadow">
                                                   ...
                                                   <input type="text" name="dni" id = "dni_user" class="form-control" value="<?php echo $d->dni; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    <!---->
                                    ...
                                    <div class="row clearfix d-flex justify-content-center">
                                            <div class="col-md-5">
                                                <div class="input-group shadow">
                                                    ...
                                                    <input value = "<?php echo $d->nom; ?>" type="text" name="nom" class="form-control" placeholder="NOMBRE">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group shadow">
                                                    <label for="" class="input-group-text"><span class = "fas fa-fw fa-user"></span></label>
                                                    <input value = "<?php echo $d->ape; ?>" type="text" name="ape" class="form-control" placeholder="APELLIDO">
                                                </div>
                                            </div>
                                        </div>
                                    <!---->
                                    ...
                                    <div class="row clearfix d-flex justify-content-center">
                                            <div class="col-md-5">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input value = "<?php echo $d->mail; ?>" type="text" name="mail" id="mail" class="form-control" placeholder="XX@XX.com">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group mb-3">
                                                   ...
                                                   <input value = "<?php echo $d->telf; ?>" type="text" name="telf" id="telf" class="form-control" placeholder="XXXX-XXXXXXX">
                                                </div>
                                            </div>
                                        </div>
                                    <!---->
                                     ...
                                     <div class="row clearfix d-flex justify-content-center">
                                        <div class="col-md-6">
                                            <div class="input-group shadow">
                                                ...
                                                <input type="text" name="fec_nac" id="fec_nac" class="form-control" placeholder = " fecha de nacimiento"value = "<?php echo date("d/m/Y", strtotime($d->fec)); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row clearfix d-flex justify-content-center">
                                            <div class="col-md-5">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="user" id="user" class="form-control" placeholder="NOMBRE DE USUARIO" value="<?php echo $d->usr; ?>">
                                                </div>
                                            </div>
